        ...
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-white/[0.08] bg-ink2/60 backdrop-blur-xl p-8 shadow-xl text-center">
            <div className="flex justify-center mb-4">
              <CheckCircle className="h-12 w-12 text-[#6fcf97]" />
            </div>
            <h2 className="text-xl font-semibold text-[#f8f8fc] mb-2">Verifique seu e-mail</h2>
            <p className="text-sm text-[#f8f8fc]/55 mb-1">
              Se <span className="text-[#f8f8fc]/85 font-medium">{submittedEmail}</span> estiver
              cadastrado, você receberá um link para redefinir sua senha.
            </p>
            <p className="text-xs text-[#f8f8fc]/45 mt-3 mb-6">
              O link expira em 1 hora. Verifique também a pasta de spam.
            </p>
            <Link
              href="/login"
              className="inline-flex items-center gap-2 text-sm text-gold-bright hover:text-gold transition-colors"
            >
    ...
    <main className="min-h-screen flex items-center justify-center bg-ink px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-ink2/60 backdrop-blur-xl p-8 shadow-xl">
          <h2 className="mb-1 text-lg font-semibold text-[#f8f8fc]">Recuperar senha</h2>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/login"
              className="inline-flex items-center gap-1.5 text-sm text-[#f8f8fc]/55 hover:text-[#f8f8fc]/85 transition-colors"
            >
              <ArrowLeft className="h-4 w-4" />
              Voltar para o login
            </Link>
